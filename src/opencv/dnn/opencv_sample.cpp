...
tResult adtf::videotb::opencv::set_stream_type_mat_format(adtf::streaming::IStreamType& oType, const adtf::streaming::tStreamImageFormat& sFormat)
{
...
tResult adtf::videotb::opencv::get_stream_type_mat_format(adtf::streaming::tStreamImageFormat& sFormat, const adtf::streaming::IStreamType& oType)
{
    adtf_util::cString strMetaType;
    oType.GetMetaTypeName(adtf_string_intf(strMetaType));
    if (strMetaType == stream_meta_type_mat::MetaTypeName)
